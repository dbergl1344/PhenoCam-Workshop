...
Each PhenoCam site may have one or more Regions of Interest (ROIs) for each vegetation type. These will have different ROI IDs (i.e. 1000, 1001, 1002). The packages we will use today allow us to interact with the PhenoCam server to extract data and process it within an R environment.
