...
This interactive part of the workshop will walk participants through
interacting with the PhenoCam Server using phenocamapi and phenocamr R
Package. Participants will learn the basics of extracting PhenoCam data
and metadata and how to work with that data through these packages. This
code was adopted from code by Bijan Seyednasrollah and Koen Hufkens.
...
visible from the camera, and its climate regime. Each PhenoCam may have
zero to several Regions of Interest (ROIs) per vegetation type. The
packages that we will use today allow us to interact with the PhenoCam
server to extract PhenoCam data and process that data in an R
environment.
